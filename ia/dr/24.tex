...
Consider a particle of mass $m_1$ with 3-momentum $\vb p_1$ which decays into two particles of mass $m_2$ and $m_3$ with 3-momenta $\vb p_2, \vb p_3$. Since 4-momentum is conserved, we get $P_1 = P_2 + P_3$. First, consider the 0 component (the timelike component) of $P$.
\[ E_1 = E_2 + E_3 \]
Now, consider the $1, 2, 3$ components (the spacelike components) of the 4-momentum. We have
\[ \vb p_1 = \vb p_2 + \vb p_3 \]
Let us look at this in the centre of momentum frame, so $\vb p_1 = 0$. Hence
\[ \vb p_2 = -\vb p_3 \]
...
Consider the decay of the Higgs particle $h$ into two photons $\gamma$. By conservation of 4-momentum,
