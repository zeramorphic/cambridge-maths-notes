...
\begin{definition}
	Suppose \(f \colon [a, \infty) \to \mathbb R\) is integrable (and therefore bounded) on every interval of the form \([a, R]\), and further, as \(R \to \infty\), we have \(\int_a^R f \to \ell\). % chktex 9
