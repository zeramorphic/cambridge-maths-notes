...
We define the standard basis vectors \(\vb e_1, \vb e_2, \cdots \vb e_n\) by setting each element of the tuple \(\vb e_i\) to zero apart from the \(i\)th element, which is set to one.
