...
\begin{definition}
	An \textit{integral domain} is a ring \( R \) with \( 0 \neq 1 \) such that for all \( a, b \in R \), we have \( a b = 0 \) implies \( a = 0 \) or \( b = 0 \).
...
\begin{proof}
	...
	\[ (a,b) \sim (c,d) \sim (e,f) \implies ad = bc; cf = de \implies adf = bcf = bde \implies af = be \implies (a,b) \sim (e,f) \]
