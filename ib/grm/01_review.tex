...
\begin{enumerate}[(i)]
	\item if \( \varphi \colon G \to H \), then \( \frac{G}{\ker \varphi} \cong \Im \varphi \);
	\item if \( H \leq G \) and \( N \trianglelefteq G \), then \( H \cap N \trianglelefteq H \) and \( \frac{H}{H \cap N} \cong \frac{HN}{N} \);
	\item if \( N \leq M \leq G \) such that \( N \trianglelefteq G \) and \( M \trianglelefteq G \), then \( \frac{M}{N} \trianglelefteq \frac{G}{N} \), and \( \frac{G/N}{M/N} = \frac{G}{M} \).
\end{enumerate}
