...
\begin{proof}
	...
	\]
	where we have usedthe fact that for \( t \in (0,\frac{\pi}{2}] \), \( \varphi(t) \equiv \frac{\sin t}{t} \geq \frac{2}{\pi} \) since \( \varphi(\frac{\pi}{2}) = \frac{2}{\pi} \) and \( \varphi'(t) \keq 0 \) on \( [0,\frac{\pi}{2}] \).
\end{proof}
...
\begin{example}
	...
	For \( N \in \mathbb N \), let \( \gamma_N \) be the positively oriented boundary of the square defined by the lines \( x = \pm (N + \frac{1}{2}) \) and \( y = \pm i(N + \frac{1}{2} \).
	By the residue theorem,
	\begin{equation}
		\int_{\gamma_N} f(z) \dd{z} = 2\pi i \qty[2\qty(\sum_{n=1}^N \frac{1}{n^2}) - \frac{\pi^2}{3}] \tag{\(\ast\)}
	\end{equation}
	Since \( \length(\gamma_N) = 4(2N + 1) \), we have
	\begin{align*}
