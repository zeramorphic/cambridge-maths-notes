...
TODO: Move this to residue theorem section
\begin{example}
	...
	Let \( \gamma \) be the positively-oriented `keyhole countour' determined by the two circular arcs \( \gamma_R \colon [\theta,2\pi-\theta] \to U \) and the two line segments \( \gamma_1, \gamma_2 \colon [\varepsilon, R] \) given by
	\[ \gamma_R(t) = Re^{it};\quad \gamma_\varepsilon(t) = \varepsilon e^{i(2\pi - t)}; \gamma_1(t) = ...
	TODO Complete this
