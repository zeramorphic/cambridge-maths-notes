...
\begin{proof}
	...
	Hence, \( P^{n+m+r}(j,j) \geq P^n(j,i) P^r(i,i) P^n(i,j) \).
...
\begin{proof}
	...
	\begin{align*}
		\prob{Z_{n+1} = y \mid Z_n = x, A} & = \prob{Z_{n+1} = y, T > n \mid Z_n = x, A} + \prob{Z_{n+1} = y, T \leq n \mid Z_n = x, A}                                                            \\
		                                   & = \prob{X_{n+1} = y \mid T > n, Z_n = x, A} \prob{T > n \mid Z_n = x, A} + \prob{Y_n+1 = y \mid T \leq n, Z_n = x, A} \prob{T \leq n \mid Z_n = x, A}
	\end{align*}
	Now,
	\[
		\prob{X_{n+1} = y \mid T > n, Z_n = x, A} = \sum_z \prob{X_{n+1} = y \mid T>n, Z_n = x, Y_n = z, A} \prob{Y_n = z \mid T > n, Z-n = x, A}
	\]
	...
	\begin{align*}
		\abs{\prob{X_n = y} - \pi(y)} & = \abs{\prob{Z_n = y} - \prob{Y_n = y}}                                                                     \\
		                              & = \abs{\prob{X_n = y, n < T} + \prob{Y_n = y, n \geq T} - \prob{Y_n = y, n < T} - \prob{Y_n = y, n \geq T}} \\
