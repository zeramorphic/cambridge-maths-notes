...
\end{proposition}
\begin{proof}
	First, we show (a)(i) implies (a)(ii). % chktex 36
	...
	Now, (a)(ii) implies (a)(iii). % chktex 36
	Let \( V \) be a neighbourhood of \( f(x) \) in \( M' \).
	...
	Finally, (a)(iii) implies (a)(i). % chktex 36
	...
	Now, (b)(i) implies (b)(ii). % chktex 36
	Let \( V \) be open in \( M' \).
	So pick \( x \in f^{-1}(V) \).
	Then, \( f(x) \in V \).
	...
	Finally, (b)(ii) implies (b)(i). % chktex 36
	Consider \( x \in M \).
