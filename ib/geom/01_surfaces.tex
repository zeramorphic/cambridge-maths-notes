...
\begin{definition}
	...
	\begin{enumerate}[(i)]
		...
		\item a finite subset \( E = \qty{e_i \colon [0,1] \to \Sigma} \) which are continuous injections and pairwise disjoint except perhaps at the endpoints, which are elements of \( e^{-1} V \);
