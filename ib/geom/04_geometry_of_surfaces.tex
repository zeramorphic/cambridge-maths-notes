...
\end{lemma}
\begin{remark}
	The first fundamental form is a non-degenerate symmetric bilinear form on \( T_p \Sigma \), whereas the second fundamental form may be degenerate, and it is a quadratic form on \( T_p \Sigma \).
\end{remark}
