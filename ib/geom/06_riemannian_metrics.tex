...
\end{definition}
\begin{lemma}
	The hyperbolic disk \( (D^2, g_{\text{hyp}}) \) and the hyperbolic upper half-plane \( (\mathfrak{h},g_{\text{hyp}}) \) are isometric.
\end{lemma}
\begin{proof}
...
We now would like to understand the full isometry group of the disk \( (D, g_{\text{hyp}}) \) or \( (\mathfrak{h}, g_{\text{hyp}}) \).
