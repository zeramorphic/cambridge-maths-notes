...
Note, if \( g = 0 \) we have \( \kappa \equiv +1 \) since this is the sphere, and if \( g = 1 \) we have \( \kappa \equiv 0 \) since this is the torus as a quotient \( \faktor{\mathbb R^2}{\mathbb Z^2} \).
