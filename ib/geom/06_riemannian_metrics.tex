...
\end{proof}
\begin{corollary}
	In the hyperbolic upper half-plane, it is globally isometric to the hyperbolic disc, so every pair of points is joined by a unique geodesic, up to reparametrisation.
