...
\noindent This is just the same as the simplex method discussed before, apart from step \((\ast)\). No proof will be given for why this step achieves the same result as the full simplex algorithm.
...
\end{alignat*}
    ...
    Consider \( \frac{10}{1}, \frac{10}{2}, \frac{20}{2} \). The smallest is \( \frac{10}{2} = 5 \), so the \textit{favourite element} is the number 2 in the 1st column and 2nd row.
    ...
    Consider \( \frac{5}{1.5}, \frac{5}{0.5}, \frac{10}{1} \). The smallest is \( \frac{5}{1.5} \), so the favourite element is the \(1.5\) in the 1st row and 2nd column.
