...
Some rules let us construct proofs, called \emph{introduction rules}.
\begin{mathpar}
    \inferrule[\( \wedge \)-I]{\Gamma \vdash A \and \Gamma \vdash B}{\Gamma \vdash A \wedge B}
    \and
    \inferrule[\( \vee \)-I]{\Gamma \vdash A}{\Gamma \vdash A \vee B}
    \and
    \inferrule{\Gamma \vdash B}{\Gamma \vdash A \vee B}
\end{mathpar}
Dually, some rules let us extract information from proofs, called \emph{elimination rules}.
\begin{mathpar}
