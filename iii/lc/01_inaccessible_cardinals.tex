...
\begin{enumerate}
    ...
    This argument generalises to all successor cardinals, so all successor cardinals \( \aleph_{\alpha + 1} \) are regular.
...
\end{proof}
The definition of inaccessibility is precisely what is needed for this proof to work.
