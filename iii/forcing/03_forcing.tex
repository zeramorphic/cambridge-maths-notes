...
\begin{proof}
    ...
    \begin{itemize}
        \item For atomic formulas, let \( \box \) be either \( \in \) or \( \subseteq \).
        Then \( p \Vdash \dot x \mathrel{\box} \dot y \) if and only if some set \( A \) is dense below \( p \).
        Take \( q \leq p \), then \( A \) is dense below \( q \).
        Then \( q \Vdash \dot x \mathrel{\box} \dot y \) as required.
    ...
    \begin{itemize}
        \item For atomic formulas, let \( \box \) is either \( \in \) or \( \subseteq \).
        To prove that \( p \Vdash \dot x \mathrel{\box} \dot y \), we must show that some set \( A \) is dense below \( p \).
        By assumption, the set \( \qty{r \mid r \Vdash \dot x \mathrel{\box} \dot y} \) is dense below \( p \).
        Fix \( q \leq p \), then there is \( r \leq q \) such that \( r \Vdash \dot x \mathrel{\box} \dot y \).
        Hence there is some \( s \leq r \leq q \leq p \) such that \( s \in A \).
        Therefore \( p \Vdash \dot x \mathrel{\box} \dot y \) as required.
...
\begin{proposition}
    ...
    \end{enumerate}
\end{proposition}
We now aim to show the following theorem.
