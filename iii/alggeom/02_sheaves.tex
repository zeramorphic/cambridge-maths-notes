...
\begin{proof}
    Let \( \mathcal F \) be a presheaf on \( X \).
    % Define \( \mathcal F^{\mathrm{sh}}(U) \) to be the set of functions
    % \[ f : U \to \coprod_{p \in U} \mathcal F_p \]
    % such that blah
    ...
    % locally, this function looks like some element of the original presheaf
