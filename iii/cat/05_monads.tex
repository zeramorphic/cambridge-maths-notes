...
\begin{definition}
    ...
    % https://q.uiver.app/#q=WzAsMyxbMCwwLCJBIl0sWzEsMCwiQiJdLFsyLDAsIkMiXSxbMCwxLCJmIiwwLHsib2Zmc2V0IjotNH1dLFsxLDIsImgiLDAseyJvZmZzZXQiOi0yfV0sWzAsMSwiZyIsMV0sWzEsMCwidCIsMCx7Im9mZnNldCI6LTR9XSxbMiwxLCJzIiwwLHsib2Zmc2V0IjotMn1dXQ==
\[\begin{tikzcd}
	A & B & C
	\arrow["f", shift left=4, from=1-1, to=1-2]
	\arrow["h", shift left=2, from=1-2, to=1-3]
	\arrow["g"{description}, from=1-1, to=1-2]
	\arrow["t", shift left=4, from=1-2, to=1-1]
...
\begin{definition}
    ...
    % https://q.uiver.app/#q=WzAsMyxbMCwwLCJHQSJdLFsxLDAsIkdCIl0sWzIsMCwiQyJdLFswLDEsIkdmIiwwLHsib2Zmc2V0IjotNH1dLFsxLDIsImgiLDAseyJvZmZzZXQiOi0yfV0sWzAsMSwiR2ciLDFdLFsxLDAsInQiLDAseyJvZmZzZXQiOi00fV0sWzIsMSwicyIsMCx7Im9mZnNldCI6LTJ9XV0=
\[\begin{tikzcd}[column sep=large]
	GA & GB & C
	\arrow["Gf", shift left=4, from=1-1, to=1-2]
	\arrow["h", shift left=2, from=1-2, to=1-3]
	\arrow["Gg"{description}, from=1-1, to=1-2]
	\arrow["t", shift left=4, from=1-2, to=1-1]
	\arrow["s", shift left=2, from=1-3, to=1-2]
\end{tikzcd}\]
    in \( \mathcal C \).
...
\end{tikzcd}\]
is \( G \)-split, as
% https://q.uiver.app/#q=
\[\begin{tikzcd}[column sep=huge]
	GFGFA & GFA & C
	\arrow["GF\alpha", shift left=4, from=1-1, to=1-2]
	\arrow["\alpha", shift left=2, from=1-2, to=1-3]
	\arrow["{G\epsilon_{FA}=\mu_A}"{description}, from=1-1, to=1-2]
	\arrow["{\eta_{GFA}}", shift left=4, from=1-2, to=1-1]
	\arrow["{\eta_A}", shift left=2, from=1-3, to=1-2]
\end{tikzcd}\]
...
\end{tikzcd}\]
        % TODO: Loops s, t on A
        with \( rf = rg = 1_B, fr = s, gr = t \), then a diagram \( D \) of this shape is a reflexive pair.
...
\end{tikzcd}\]
        ...
        % https://q.uiver.app/#q=WzAsMyxbMCwwLCJQQyJdLFsxLDAsIlBCIl0sWzIsMCwiUEEiXSxbMCwxLCJQXlxcc3RhciBmIiwwLHsib2Zmc2V0IjotNH1dLFsxLDIsIlBeXFxzdGFyIGUiLDAseyJvZmZzZXQiOi0yfV0sWzIsMSwiUGUiLDAseyJvZmZzZXQiOi0yfV0sWzAsMSwiUF5cXHN0YXIgZyIsMV0sWzEsMCwiUGciLDAseyJvZmZzZXQiOi00fV1d
\[\begin{tikzcd}
	PC & PB & PA
	\arrow["{P^\star f}", shift left=4, from=1-1, to=1-2]
	\arrow["{P^\star e}", shift left=2, from=1-2, to=1-3]
	\arrow["Pe", shift left=2, from=1-3, to=1-2]
	\arrow["{P^\star g}"{description}, from=1-1, to=1-2]
	\arrow["Pg", shift left=4, from=1-2, to=1-1]
\end{tikzcd}\]
...
\end{tikzcd}\]
        ...
        % https://q.uiver.app/#q=WzAsMyxbMCwwLCJVWCJdLFsxLDAsIlVZIl0sWzIsMCwiWiJdLFswLDEsIlVmIiwwLHsib2Zmc2V0IjotNH1dLFsxLDIsImgiLDAseyJvZmZzZXQiOi0yfV0sWzIsMSwicyIsMCx7Im9mZnNldCI6LTJ9XSxbMCwxLCJVZyIsMV0sWzEsMCwidCIsMCx7Im9mZnNldCI6LTR9XV0=
\[\begin{tikzcd}
	UX & UY & Z
	\arrow["Uf", shift left=4, from=1-1, to=1-2]
	\arrow["h", shift left=2, from=1-2, to=1-3]
	\arrow["s", shift left=2, from=1-3, to=1-2]
	\arrow["Ug"{description}, from=1-1, to=1-2]
	\arrow["t", shift left=4, from=1-2, to=1-1]
\end{tikzcd}\]
...
\end{tikzcd}\]
    where \( \mathbb T \) is the monad induced by \( F \dashv G \), \( K \) is the comparison functor, \( \mathbb S \) is the monad induced by \( L \dashv K \), and so on.
    % TODO: why L \dashv K? by 5.9?
