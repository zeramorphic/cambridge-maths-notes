...
\begin{example}
    ...
    Consider the projection from \( (0 : 0 : 1) \), and restrict this projection to \( C \) to obtain a map \( p \colon C \dashrightarrow \mathbb P^1 \).
    By changing representatives, we can show \( p \) is a morphism, even though \( (0 : 0 : 1) \in C \).
\end{example}
